...
class EventsGeneration(Resource):
    def post(self):
        ...
        try:
            ...
            def generate_events(user_ids, events_generator_class):
                for user_id in user_ids:
                    events_generator: EventsGenerator = events_generator_class(user_id)
                    events_generator.generate_events()

            executor.submit(generate_events, user_ids, events_generator_class)
