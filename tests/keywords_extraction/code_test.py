...
def yake_method():
    ...
    yake_keyphrases = yake.extract_keywords(patent)
    print(yake_keyphrases[:10])
    # => duplications
...
def text_rank():
    ...
    print([phrase.text for phrase in textrank_keyphrases[:10]])
...
def keybert():
    ...
    kw_model = KeyBERT()
    keywords = kw_model.extract_keywords(patent)
    print(keywords[:10])
