...
CREATE TABLE public.md_user_workflow (
    ...
    character varying(255) integer NOT NULL,
    workflow_fk integer NOT NULL,
);
...
ALTER TABLE ONLY public.md_user_workflow
    ADD CONSTRAINT md_user_workflow_user_fk_fkey FOREIGN KEY (user_fk) REFERENCES public.md_user(user_pk);
...
CREATE TABLE public.md_user_workflow_step_execution (
    ...
    user_workflow_step_fk integer NOT NULL
);
...
ALTER TABLE ONLY public.md_user_workflow_step_execution
    ADD CONSTRAINT md_user_workflow_step_execution_user_workflow_step_fk_fkey FOREIGN KEY (user_workflow_step_fk) REFERENCES public.md_user_workflow_step(user_workflow_step_pk);
...
ALTER TABLE ONLY public.md_user_workflow_step_execution_run
    ADD CONSTRAINT md_user_workflow_step_execution_run_user_workflow_step_execution_fk_fkey FOREIGN KEY (user_workflow_step_execution_fk) REFERENCES public.md_user_workflow_step_execution(user_workflow_step_execution_pk);
...
ALTER TABLE ONLY public.user_workflow_step_execution_run_result
    ADD CONSTRAINT user_workflow_step_execution_run_result_user_workflow_step_execution_run_fk_fkey FOREIGN KEY (user_workflow_step_execution_run_fk) REFERENCES public.md_user_workflow_step_execution_run(user_workflow_step_execution_run_pk);
