...
class RescheduleTodoCortex:
    ...
    def __init__(self, todo):
        try:
            ...
            EmailService().send_technical_error_email(f"Error in {self.logger_prefix} - __init__ (todo_pk: {todo.todo_pk}): {e}")
    ...
    def reschedule_todo(self):
        try:
            ...
            EmailService().send_technical_error_email(f"Error in {self.logger_prefix} - todo_pk {self.todo_pk} - reschedule_todo: {e}")
