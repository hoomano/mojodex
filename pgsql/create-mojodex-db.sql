...
--
-- Name: md_profile_status_; Type: TYPE; Schema: public; Owner: assistant_db_user
--

CREATE TYPE public.md_profile_status_ AS ENUM (
    'active',
    'inactive'
);


ALTER TYPE public.md_profile_status_ OWNER TO assistant_db_user;
...
--
-- Name: md_profile_seq; Type: SEQUENCE; Schema: public; Owner: assistant_db_user
--

CREATE SEQUENCE public.md_profile_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.md_profile_seq OWNER TO assistant_db_user;

--
-- Name: md_profile; Type: TABLE; Schema: public; Owner: assistant_db_user
--

CREATE TABLE public.md_profile (
    profile_pk integer DEFAULT nextval('public.md_profile_seq'::regclass) NOT NULL,
    product_stripe_id character varying(255),
    status public.md_profile_status_ NOT NULL,
    profile_category_fk integer,
...
ALTER TABLE public.md_profile OWNER TO assistant_db_user;

--
-- Name: md_profile_category_pk_seq; Type: SEQUENCE; Schema: public; Owner: assistant_db_user
--

CREATE SEQUENCE public.md_profile_category_pk_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.md_profile_category_pk_seq OWNER TO assistant_db_user;

--
-- Name: md_profile_category; Type: TABLE; Schema: public; Owner: assistant_db_user
--

CREATE TABLE public.md_profile_category (
    profile_category_pk integer DEFAULT nextval('public.md_profile_category_pk_seq'::regclass) NOT NULL,
...
ALTER TABLE public.md_profile_category OWNER TO assistant_db_user;

--
-- Name: md_profile_category_displayed_data_seq; Type: SEQUENCE; Schema: public; Owner: assistant_db_user
--

CREATE SEQUENCE public.md_profile_category_displayed_data_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.md_profile_category_displayed_data_seq OWNER TO assistant_db_user;

--
-- Name: md_profile_category_displayed_data; Type: TABLE; Schema: public; Owner: assistant_db_user
--

CREATE TABLE public.md_profile_category_displayed_data (
    profile_category_displayed_data_pk integer DEFAULT nextval('public.md_profile_category_displayed_data_seq'::regclass) NOT NULL,
    profile_category_fk integer NOT NULL,
    language_code character varying(2) NOT NULL,
...
ALTER TABLE public.md_profile_category_displayed_data OWNER TO assistant_db_user;

--
-- Name: md_profile_displayed_data_seq; Type: SEQUENCE; Schema: public; Owner: assistant_db_user
--

CREATE SEQUENCE public.md_profile_displayed_data_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.md_profile_displayed_data_seq OWNER TO assistant_db_user;

--
-- Name: md_profile_displayed_data; Type: TABLE; Schema: public; Owner: assistant_db_user
--

CREATE TABLE public.md_profile_displayed_data (
    profile_displayed_data_pk integer DEFAULT nextval('public.md_profile_displayed_data_seq'::regclass) NOT NULL,
...
ALTER TABLE public.md_profile_displayed_data OWNER TO assistant_db_user;

--
-- Name: md_profile_task_seq; Type: SEQUENCE; Schema: public; Owner: assistant_db_user
--

CREATE SEQUENCE public.md_profile_task_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.md_profile_task_seq OWNER TO assistant_db_user;

--
-- Name: md_profile_task; Type: TABLE; Schema: public; Owner: assistant_db_user
--

CREATE TABLE public.md_profile_task (
    profile_task_pk integer DEFAULT nextval('public.md_profile_task_seq'::regclass) NOT NULL,
    profile_fk integer NOT NULL,
    task_fk integer NOT NULL
);


ALTER TABLE public.md_profile_task OWNER TO assistant_db_user;

--
-- Name: md_role_seq; Type: SEQUENCE; Schema: public; Owner: assistant_db_user
--

CREATE SEQUENCE public.md_role_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.md_role_seq OWNER TO assistant_db_user;

--
-- Name: md_role; Type: TABLE; Schema: public; Owner: assistant_db_user
--

CREATE TABLE public.md_role (
    role_pk integer DEFAULT nextval('public.md_role_seq'::regclass) NOT NULL,
    ...
    custom_role_id character varying(255)
);


ALTER TABLE public.md_role OWNER TO assistant_db_user;
...
--
-- Name: md_profile_category_displayed_data md_profile_category_displayed_data_pkey; Type: CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile_category_displayed_data
    ADD CONSTRAINT md_profile_category_displayed_data_pkey PRIMARY KEY (profile_category_displayed_data_pk);


--
-- Name: md_profile_category md_profile_category_pkey; Type: CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile_category
    ADD CONSTRAINT md_profile_category_pkey PRIMARY KEY (profile_category_pk);


--
-- Name: md_profile_displayed_data md_profile_displayed_data_pkey; Type: CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile_displayed_data
    ADD CONSTRAINT md_profile_displayed_data_pkey PRIMARY KEY (profile_displayed_data_pk);


--
-- Name: md_profile md_profile_pkey; Type: CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile
    ADD CONSTRAINT md_profile_pkey PRIMARY KEY (profile_pk);


--
-- Name: md_profile_task md_profile_task_pkey; Type: CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile_task
    ADD CONSTRAINT md_profile_task_pkey PRIMARY KEY (profile_task_pk);
...
--
-- Name: md_profile profile_label_key; Type: CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile
    ADD CONSTRAINT profile_label_key UNIQUE (label);


--
-- Name: md_role role_pkey; Type: CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_role
    ADD CONSTRAINT role_pkey PRIMARY KEY (role_pk);
...
--
-- Name: md_profile md_profile_category_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile
    ADD CONSTRAINT md_profile_category_fkey FOREIGN KEY (profile_category_fk) REFERENCES public.md_profile_category(profile_category_pk);


--
-- Name: md_profile_category_displayed_data md_profile_category_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--
...
--
-- Name: md_profile_displayed_data md_profile_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile_displayed_data
    ADD CONSTRAINT md_profile_fkey FOREIGN KEY (profile_fk) REFERENCES public.md_profile(profile_pk);
...
--
-- Name: md_profile_task profile_task_profile_fk_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile_task
    ADD CONSTRAINT profile_task_profile_fk_fkey FOREIGN KEY (profile_fk) REFERENCES public.md_profile(profile_pk);


--
-- Name: md_profile_task profile_task_task_fk_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_profile_task
    ADD CONSTRAINT profile_task_task_fk_fkey FOREIGN KEY (task_fk) REFERENCES public.md_task(task_pk);


--
-- Name: md_role role_profile_fk_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_role
    ADD CONSTRAINT role_profile_fk_fkey FOREIGN KEY (profile_fk) REFERENCES public.md_profile(profile_pk);


--
-- Name: md_role role_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_role
    ADD CONSTRAINT role_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.md_user(user_id);
...
--
-- Name: md_user user_profile_category_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_user
    ADD CONSTRAINT user_profile_category_fkey FOREIGN KEY (profile_category_fk) REFERENCES public.md_profile_category(profile_category_pk);


--
-- Name: md_user_task_execution user_task_execution_role_fkey; Type: FK CONSTRAINT; Schema: public; Owner: assistant_db_user
--

ALTER TABLE ONLY public.md_user_task_execution
    ADD CONSTRAINT user_task_execution_role_fkey FOREIGN KEY (role_fk) REFERENCES public.md_role(role_pk);
